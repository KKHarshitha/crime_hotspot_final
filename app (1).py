...
def location_wise_analysis():
    st.title("📍 Crime Hotspots in Eluru and Nearby Areas")
    m = folium.Map(location=[16.7100, 81.1000], zoom_start=12)
    ...
    if map_data and "last_clicked" in map_data:
        ...
        st.write("Detected hotspots:", nearby_hotspots)  # Debugging output
